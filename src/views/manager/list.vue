<template>
  <div>
   ...
   <!-- 头部 搜索数据 -->
<i-header-form :formList="RequestList" v-model="RequestItem" size="small">
 </i-header-form>
 
 <i-header-add :buttonList="headerButton" @handleAdd="handleAdd" @init="init">
...
import { getTableList } from "@/api/manager.js";
